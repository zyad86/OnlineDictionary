...
public class UtilTranslateAPI {
    ...
    public static StringBuffer YouDaoTranslateBuffer(String WordsToTranslate)
    {
        try {
            StringBuffer s=new StringBuffer();
             s.append(HttpRequest.sendGet("http://fanyi.youdao.com/openapi.do",
                    "keyfrom=online-dictionary&key=1058604112&type=data&doctype=json&version=1.1&q=" + WordsToTranslate));
            return s;
        } catch (java.lang.Exception e){
            System.out.println(e);
        }
        StringBuffer noReturn=new StringBuffer();
         noReturn.append("error");
        return noReturn;
    }

    public static  StringBuffer BingTranslateBuffer(String WordsToTranslate)
    {
        try {
            StringBuffer translatedText=new StringBuffer();
            translatedText.append(HttpRequest.sendGet("http://xtk.azurewebsites.net/BingDictService.aspx","Word="+WordsToTranslate));
            return translatedText;
        }catch(java.lang.Exception e){
            System.out.println(e);
        }
    ...
    public static StringBuffer JinshanTranslateBuffer(String WordsToTranslate)
    {
        try {
            StringBuffer translatedText=new StringBuffer();
            translatedText.append(HttpRequest.sendGet("http://dict-co.iciba.com/api/dictionary.php",
                    "w="+WordsToTranslate+"&key=B9B54B63282B09E32D612FBB95A92258"));
            return translatedText;
        }catch(java.lang.Exception e){
            System.out.println(e);
